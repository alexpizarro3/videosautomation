...
if not pollinations_available and not huggingface_available:
    logger.warning(" NO hay fallbacks gratuitos disponibles - solo el método principal funcionará")
else:
    logger.info(" Fallbacks gratuitos configurados correctamente")
...
def generate_image_with_fallback(prompt: str, image_path: str) -> bool:
    ...
    if pollinations_available:
        ...
        if success:
            ...
            logger.warning(" Pollinations también falló")
    ...
    if huggingface_available:
        ...
        if success:
            ...
            logger.warning(" HuggingFace también falló")
